...
export GOPATH=$(pwd)/gopath:$(pwd)/gopath/src/github.com/pdesrochers01/simple-go-web-app/Godeps/_workspace
cd gopath/src/github.com/pdesrochers01/simple-go-web-app/
